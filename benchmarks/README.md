...
cells/second plus peak memory. Its result table is kept in the README and
`docs/performance.md`; values are marked `pending CI` until that job publishes
measurements rather than mixing them with the normal-load baseline.
