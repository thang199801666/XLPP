...
public:
    ...
    PivotTable& addPivotTable(PivotTable pt) { dirty_ = true; pivotsDirty_ = true; pivotTables_.push_back(std::move(pt)); return pivotTables_.back(); }
    std::vector<PivotTable>& pivotTables() noexcept { dirty_ = true; pivotsDirty_ = true; return pivotTables_; }
    ...
    void clearDirty() const noexcept { dirty_ = false; drawingsDirty_ = false; drawingAppendDirty_ = false; pivotsDirty_ = false; }
